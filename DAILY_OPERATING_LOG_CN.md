...
建议部署后重新提交 sitemap，并用无 .html URL 做网址检查。
```

### 今日建议操作

```text
等 GitHub / Cloudflare 部署完成后：
打开 https://sellcopytools.com/sitemap.xml
确认 sitemap 里的 URL 已经没有 .html。
打开 Google Search Console -> 站点地图，重新提交：
